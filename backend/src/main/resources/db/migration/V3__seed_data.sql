...
('11111111-1111-1111-1111-111111111111', 'admin', 'admin@fynza.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('22222222-2222-2222-2222-222222222222', 'customer1', 'customer1@fynza.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('33333333-3333-3333-3333-333333333333', 'customer2', 'customer2@fynza.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
('bbbb1111-bbbb-1111-bbbb-111111111111', 'Cotton T-Shirt', 'cotton-t-shirt', '100% organic cotton t-shirt', 19.99, 500, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('bbbb2222-bbbb-2222-bbbb-222222222222', 'Denim Jeans', 'denim-jeans', 'Classic fit denim jeans', 49.99, 150, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('cccc1111-cccc-1111-cccc-111111111111', 'Garden Chair', 'garden-chair', 'Outdoor garden chair', 89.99, 75, 'cccccccc-cccc-cccc-cccc-cccccccccccc', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
