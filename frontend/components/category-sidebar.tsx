  ...
  return (
    <aside className="w-full bg-white rounded-lg border">
      ...
      <div className="p-4 border-b">
        ...
        {/* Stock Range */}
        <div className="mb-3">
          <div className="text-xs text-gray-500 mb-1">Stock Range</div>
          <div className="flex items-center gap-2">
            <input type="number" placeholder="Min" className="w-16 px-2 py-1 border rounded text-sm" />
            <span className="text-sm text-gray-400">to</span>
            <input type="number" placeholder="Max" className="w-16 px-2 py-1 border rounded text-sm" />
          </div>
        </div>

        {/* Available Quantity */}
        <div className="mb-3">
          <div className="text-xs text-gray-500 mb-1">Min Available</div>
          <input type="number" placeholder="0" className="w-full px-2 py-1 border rounded text-sm" />
        </div>
      ...
      {/* Discount */}
      <div className="p-4 border-b">
        <h3 className="font-bold text-sm mb-3">DISCOUNT</h3>

        {/* Discount Range */}
        <div className="mb-3">
          <div className="text-xs text-gray-500 mb-1">Discount Range (%)</div>
          <div className="flex items-center gap-2">
            <input type="number" min="0" max="100" placeholder="Min" className="w-16 px-2 py-1 border rounded text-sm" />
            <span className="text-sm text-gray-400">to</span>
            <input type="number" min="0" max="100" placeholder="Max" className="w-16 px-2 py-1 border rounded text-sm" />
          </div>
        </div>

        <div className="flex items-center space-x-2">
          <Checkbox id="has-discount" />
      ...
      {/* Rating & Engagement */}
      <div className="p-4">
        <h3 className="font-bold text-sm mb-3">RATING & ENGAGEMENT</h3>
