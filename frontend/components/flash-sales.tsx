    ...
    <div className="bg-[#E30613] py-4">
      <div className="container mx-auto px-4">
        ...
        <div className="relative group" onMouseLeave={handleMouseLeave}>
          ...
          <button
            onClick={() => scroll("left")}
            className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center transition-all duration-300 hover:bg-[#FF6700] hover:text-white -ml-5 opacity-0 group-hover:opacity-100 ${
              showLeftArrow && canScrollLeft ? "opacity-100" : ""
          ...
          <button
            ...
            className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center transition-all duration-300 hover:bg-[#FF6700] hover:text-white -mr-5 opacity-0 group-hover:opacity-100 ${
              showRightArrow && canScrollRight ? "opacity-100" : ""
