# Fynza Frontend Data Types & Dummy Data

This document contains all custom data types, interfaces, enums, and sample data used throughout the Fynza frontend application.

---

## Table of Contents
1. [Custom Data Types](#custom-data-types)
2. [Enums](#enums)
3. [Dummy Data](#dummy-data)
...
#### ApiError
Error object returned in API responses.
```typescript
interface ApiError {
  field?: string;
  code: string;
...
#### ProductQuery
Extended query with product-specific filters.
```typescript
...
#### TrackingEvent
Tracking event in order history.
```typescript
